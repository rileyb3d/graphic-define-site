...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: '/gallery/littlelambs-about.png', alt: 'About page' },
      { src: '/gallery/littlelambs-donate.png', alt: 'Donation page' },
      { src: '/gallery/littlelambs-contact.png', alt: 'Contact page' },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: '/gallery/scrapconomy-campaign.png', alt: 'Campaign progress page' },
      { src: '/gallery/scrapconomy-rewards.png', alt: 'Reward tiers' },
      { src: '/gallery/scrapconomy-backers.png', alt: 'Backer community page' },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: '/gallery/rileyb3d-library.png', alt: '3D asset library' },
      { src: '/gallery/rileyb3d-training.png', alt: 'Training courses' },
      { src: '/gallery/rileyb3d-tools.png', alt: 'Tools page' },
    ],
    ...
    results: [
      ...
      { label: 'Content sections', value: '5' },
      { label: 'Platform fees', value: '$0' },
    ],
